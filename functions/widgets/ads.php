...
Description: Ads a widget that shows four 120x120 px ads.
Author: James Lao	
Version: 1.0
...
function shaken_sidebar_ads_register() {
	...
	$widget_ops = array('classname' => 'shaken_sidebar_ads', 'description' => __('Configure and display up to four 120x120 sidebar advertisements.'));
